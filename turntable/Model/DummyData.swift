...
class DummyData: Datasource {
    ...
    let nowPlaying = QueueItem(track: Track(id: "fakeID", name: "I'm A Kid", imageSmall: "", imageLarge: "", artist: [Artist(id: "fakeID", name: "Jadu Heart", imageSmall: "", imageLarge: "")], runtime: 183000), session: Session(sessionCode: 345345, sessionName: "TestSession", maxGuests: 10, context: "Birthday Party", historyPlaylist: "fakePlayelist", organiser: Attendee(username: "Markyb", email: "email", spotifyKey: "token", history: true)), order: 0)
}
